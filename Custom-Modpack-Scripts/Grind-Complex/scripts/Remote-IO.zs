...
val FerromagBase = <minecraft:planks>;
...
val IridiumRod = <ore:stickIridium>;
...
[OsmiridiumGear, RemoteInterface, OsmiridiumGear],
...
[IridiumRod, NeutroniumScrew, HHammer],
[FerromagBase, DataOrb, FerromagBase]]);
// - Alternate Recipe
recipes.addShaped(Remote, [
[Wrench, IVFieldGen, HHammer],
[IridiumRod, NeutroniumScrew, Screwdriver],
[FerromagBase, DataOrb, FerromagBase]]);

// --- IO Tool
recipes.addShaped(IOTool, [
[HHammer, HSLAPlate, NeutroniumScrew],
[EFlow, IridiumRod, HSLAPlate],
[OsmiridiumGear, EFlow, Screwdriver]]);
// - Alternate Recipe
recipes.addShaped(IOTool, [
[Screwdriver, HSLAPlate, NeutroniumScrew],
[EFlow, IridiumRod, HSLAPlate],
[OsmiridiumGear, EFlow, HHammer]]);
